...
def test_version_consistency_across_repository():
    ...
    # 1. Config version
    assert APP_VERSION == "2.6.1", f"Expected APP_VERSION to be 2.6.1, got {APP_VERSION}"
...
def test_health_check_returns_v250():
    """Verify that /api/health reports authoritative version 2.6.1.6.0.5.3.5.2.5.2.5.0."""
